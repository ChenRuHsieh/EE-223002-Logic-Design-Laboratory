set_property IOSTANDARD LVCMOS33 [get_ports add_en]
set_property IOSTANDARD LVCMOS33 [get_ports clk]
set_property IOSTANDARD LVCMOS33 [get_ports PS2_CLK]
set_property IOSTANDARD LVCMOS33 [get_ports mul_en]
set_property IOSTANDARD LVCMOS33 [get_ports PS2_DATA]
set_property IOSTANDARD LVCMOS33 [get_ports rst]
set_property IOSTANDARD LVCMOS33 [get_ports sub_en]
set_property PACKAGE_PIN L1 [get_ports add_en]
set_property PACKAGE_PIN W5 [get_ports clk]
set_property PACKAGE_PIN N3 [get_ports mul_en]
set_property PACKAGE_PIN R2 [get_ports rst]
set_property PACKAGE_PIN P1 [get_ports sub_en]
