...
set_property IOSTANDARD LVCMOS33 [get_ports pb_f]
set_property IOSTANDARD LVCMOS33 [get_ports pb_s]
set_property IOSTANDARD LVCMOS33 [get_ports rst]
set_property IOSTANDARD LVCMOS33 [get_ports rst_f]
set_property IOSTANDARD LVCMOS33 [get_ports freeze_en]
set_property IOSTANDARD LVCMOS33 [get_ports count_en]
set_property IOSTANDARD LVCMOS33 [get_ports one_pusle_s]
set_property IOSTANDARD LVCMOS33 [get_ports one_pusle_f]

set_property PACKAGE_PIN W5 [get_ports clk]
set_property PACKAGE_PIN W19 [get_ports pb_f]
set_property PACKAGE_PIN T17 [get_ports pb_s]
set_property PACKAGE_PIN R2 [get_ports rst]
set_property PACKAGE_PIN N3 [get_ports rst_f]
set_property PACKAGE_PIN P1 [get_ports freeze_en]
set_property PACKAGE_PIN L1 [get_ports count_en]
set_property PACKAGE_PIN E19 [get_ports one_pusle_s]
set_property PACKAGE_PIN U16 [get_ports one_pusle_f]
