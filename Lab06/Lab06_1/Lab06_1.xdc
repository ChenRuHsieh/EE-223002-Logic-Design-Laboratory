...
set_property PACKAGE_PIN W19 [get_ports pb_in]
set_property PACKAGE_PIN T17 [get_ports rst]
set_property PACKAGE_PIN U16 [get_ports am]

set_property IOSTANDARD LVCMOS33 [get_ports choose_mode]
set_property PACKAGE_PIN L1 [get_ports choose_mode]
